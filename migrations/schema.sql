...
CREATE TABLE `borrow` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_id` (`user_id`,`ebook_id`)
...
CREATE TABLE `ebook` (
  ...
  `gutenberg_id` int(11) DEFAULT NULL,
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `gutenberg_id` (`gutenberg_id`)
...
-- Dump completed on 2020-12-17 16:14:19
